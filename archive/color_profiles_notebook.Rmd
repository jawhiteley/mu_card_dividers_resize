...
-   The color profile showing in the MUX `jpg` files appears to be the same one he Preview finds in the `ppm` exported from the MU season 1 pdf.
...
I can't even seem to reproduce colours on my printer from early tests with the same file. So confusing. :(
