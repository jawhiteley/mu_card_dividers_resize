...
params:
  ...
  border:   0.35 # in mm: Thickness of borders around dividers (added to the _outside_ of dividers: not included in the dimensions above)
# DIMENSIONS:
...
# 0.25 mm is a little thinner between dividers, but a bit thicker around the outside (keeping all borders at the same width).
