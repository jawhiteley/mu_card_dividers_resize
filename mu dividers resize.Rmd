...
\def\DivWidth{`r params$div_width`mm}       % Width of each divider (originals are 3.620 in, not sure if that includes the border)
\def\DivHeight{`r params$div_height`mm}     % Height of each divider (originals are 2.613 in, which is too short for sleeved cards)
