...
params:
  modular_code: modular_code/MU-promos-witching.Rmd    # path to R script with modular code (for a specific set of input files)
...
```{r output, echo=FALSE, out.width='100%', results='asis'}
# Loop over the list and include graphics, 
# which should apply the custom LaTeX command defined above (for \includegraphics).
